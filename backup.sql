...
\restrict yOtbaDIfZgwqN3bA6ZiRrApMTnsd7iQ9qlbqiLIPZAVeLoCGalvdoUxxabTx7YE
...
COPY public.classes (id, name, teacher_id) FROM stdin;
1	5eme A	1
2	5eme B	2
\.
...
COPY public.students (id, user_id, class_id, first_name, last_name, age, grades) FROM stdin;
1	4	1	Achraf	Bennani	20	{15.5,18,17}
2	5	1	Hugo	Bernard	19	{12,14.5,16}
3	6	2	Andre	Leroy	21	{18,19.5,20}
4	\N	\N	bob	marin	20	{}
\.
...
COPY public.teachers (id, user_id, first_name, last_name) FROM stdin;
1	2	Jean	Dupont
2	3	Marie	Martin
\.
...
2	teacher1@test.com	teach123	teacher
3	teacher2@test.com	teach123	teacher
4	student1@test.com	stud123	student
5	student2@test.com	stud123	student
6	student3@test.com	stud123	student
\.
...
\unrestrict yOtbaDIfZgwqN3bA6ZiRrApMTnsd7iQ9qlbqiLIPZAVeLoCGalvdoUxxabTx7YE
